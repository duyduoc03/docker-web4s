...
require __DIR__ . DIRECTORY_SEPARATOR . 'constants_list.php';
require __DIR__ . DIRECTORY_SEPARATOR . 'constants_permission.php';
require __DIR__ . DIRECTORY_SEPARATOR . 'constants_filemanager.php';
...
(new \Cake\Core\Configure\Engine\PhpConfig())->read('.env');
