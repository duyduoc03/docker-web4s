<div class="kt-list-locales">
                ...
                <div class="col-lg-3">
                    <div class="kt-radio-inline kt-radio-inline-type-file">
                        <label class="kt-radio mb-0">
                            <input type="radio" name="type_file" nh-change-type data-type="system_po" checked="checked" /> File
                            locales.po
                            <span></span>
                        </label>
                        <label class="kt-radio mb-0">
                            <input type="radio" name="type_file" nh-change-type data-type="system_js"/> File locales.js
                            <span></span>
                        </label>
                    </div>
                </div>
    ...
    <div nh-form-table="table-locales-template" >			
    </div>
</div>