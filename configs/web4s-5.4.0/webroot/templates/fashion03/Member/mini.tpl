...
<div class="dropdown show">
    <a class="text-body ml-3 align-items-center d-flex" href="javascript:;" role="button" id="member-info" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <img class="img-fluid rounded-circle" src="{$member_img}" alt="{if !empty($member_info.full_name)}{$member_info.full_name}{/if}" title="{if !empty($member_info.full_name)}{$member_info.full_name}{/if}"  style="width: 3rem;height: 3rem;">
