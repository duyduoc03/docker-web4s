# Script khởi động Web4s v5.4-v5.5.0 với PHP 8.1
Write-Host "Khởi động Web4s v5.4-v5.5.0 (PHP 8.1)..." -ForegroundColor Green
...
# Khởi động Web4s v5.4-v5.5.0
docker-compose -f docker-compose.web4s-v5.4-v5.5.0.yml up -d --build

Write-Host "Web4s v5.4-v5.5.0 đã được khởi động!" -ForegroundColor Green
