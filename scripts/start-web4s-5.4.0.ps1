# Script khởi động Web4s 5.4.0 với PHP 8.1
Write-Host "Khởi động Web4s 5.4.0 (PHP 8.1)..." -ForegroundColor Green
...
Write-Host "Web4s 5.4.0 đã được khởi động!" -ForegroundColor Green
